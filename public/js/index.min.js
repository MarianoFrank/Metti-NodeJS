...
window.addEventListener("DOMContentLoaded", () => {
  ...
  const editor = new _editorjs_editorjs__WEBPACK_IMPORTED_MODULE_1__["default"]({
    holder: "editorjs",
    placeholder: "Descripcion aqui...",
    tools: {
      header: _editorjs_header__WEBPACK_IMPORTED_MODULE_2__["default"],
      list: _editorjs_list__WEBPACK_IMPORTED_MODULE_3__["default"]
    }
  });
  const convertBlockToHTML = async function () {
    ...
    const edjsParser = editorjs_html__WEBPACK_IMPORTED_MODULE_4__();
  ...
  new dropzone__WEBPACK_IMPORTED_MODULE_0__["default"](form, {
    ...
    method: "POST",
    addRemoveLinks: false,
    dictFileTooBig: "Archivo muy pesado ({{filesize}}MB). Max: {{maxFilesize}}MB.",
    ...
    init: function () {
      ...
      myDropzone.on("success", function () {
        window.location.href = "/dashboard?msg=Grupo%20creado%20correctamente&type=success";
      });
      myDropzone.element.querySelector("button[type=submit]").addEventListener("click", async function (e) {
        e.preventDefault();
        e.stopPropagation();
...
/*!*************************!*\
  ...
  \*************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _groupsFrom_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./groupsFrom.js */ "./src/js/groupsFrom.js");
